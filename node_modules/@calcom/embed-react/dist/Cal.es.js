...
function X(g = fr) {
  (function(d, h, _) {
    ...
    d.Cal = d.Cal || function() {
      ...
      if (c.loaded || (c.ns = {}, c.q = c.q || [], T.head.appendChild(T.createElement("script")).src = h, c.loaded = !0), v[0] === _) {
        const s = function() {
          R(s, arguments);
        }, m = v[1];
...
function vr() {
  if (Te)
    return A;
  Te = 1;
  var g = Oe, d = Symbol.for("react.element"), h = Symbol.for("react.fragment"), _ = Object.prototype.hasOwnProperty, R = g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, T = { key: !0, ref: !0, __self: !0, __source: !0 };
  function c(v, s, m) {
    var p, C = {}, S = null, $ = null;
